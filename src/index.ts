...
const create = (client: Client) => {
  ...
  return {
    createProvinces: () => createQuery(() => ({ queryKey: [name_provinces], queryFn: fetcher_provinces })),
    createProvince: (code: string) =>
      createQuery(() => ({ queryKey: [name_provinces, code], enabled: isCode(code), queryFn: fetcher_province })),
    createDistricts: (parent: string) =>
      createQuery(() => ({ queryKey: [name_provinces, parent, str_districts], enabled: isCode(parent), queryFn: fetcher_districts })),
    createDistrict: (code: string) =>
      createQuery(() => ({ queryKey: [name_districts, code], enabled: isCode(code), queryFn: fetcher_district })),
    createSubdistricts: (parent: string) =>
      createQuery(() => ({ queryKey: [name_districts, parent, str_subdistricts], enabled: isCode(parent), queryFn: fetcher_subdistricts })),
    createSubdistrict: (code: string) =>
      createQuery(() => ({ queryKey: [name_subdistricts, code], enabled: isCode(code), queryFn: fetcher_subdistrict })),
    createVillages: (parent: string) =>
      createQuery(() => ({ queryKey: [name_subdistricts, parent, str_villages], enabled: isCode(parent), queryFn: fetcher_villages })),
    createVillage: (code: string) =>
      createQuery(() => ({ queryKey: [name_villages, code], enabled: isCode(code), queryFn: fetcher_village })),
    createRegion: (code: string) => createQuery(() => ({ queryKey: [name_region, code], enabled: isCode(code), queryFn: fetcher_region })),
    createSearch: (name: string) => createQuery(() => ({ queryKey: [name_search, name], enabled: isName(name), queryFn: fetcher_search })),
    createSearchProvinces: (name: string) =>
      createQuery(() => ({ queryKey: [name_search, name, str_provinces], enabled: isName(name), queryFn: fetcher_search_provinces })),
    createSearchDistricts: (name: string) =>
      createQuery(() => ({ queryKey: [name_search, name, str_districts], enabled: isName(name), queryFn: fetcher_search_districts })),
    createSearchSubdistricts: (name: string) =>
      createQuery(() => ({ queryKey: [name_search, name, str_subdistricts], enabled: isName(name), queryFn: fetcher_search_subdistricts })),
    createSearchVillages: (name: string) =>
      createQuery(() => ({ queryKey: [name_search, name, str_villages], enabled: isName(name), queryFn: fetcher_search_villages })),
  };
};
