...
<img src="https://hiiits.deno.dev/hit/regions-of-indonesia/solid-query?" width="100%" heigth="10px" />

# Regions of Indonesia Solid Query

Regions of Indonesia [Solid Query](https://tanstack.com/query/latest/docs/solid/overview) integration.
